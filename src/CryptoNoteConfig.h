...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xf179f7350;
...
const size_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT              = 16;
...
const char     CRYPTONOTE_NAME[]                             = "BWCCMCCoin";
